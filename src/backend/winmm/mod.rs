//! Windows WinMM backend — UMP stub until Windows MIDI Services is wired.
//!
//! See `docs/ump-backend-compliance.md`. Enumeration returns an empty list so
//! hosts do not open legacy MIDI 1.0 ports as if they were UMP.
